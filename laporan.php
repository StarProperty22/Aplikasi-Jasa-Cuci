...
if ($_SESSION['level'] != 1 && $_SESSION['level'] != 2) {
    echo '<strong>ERROR!</strong> Anda tidak memiliki akses untuk melihat laporan.';
    return; // Hentikan eksekusi lebih lanjut
}

// Jika pengguna memiliki akses, lanjutkan dengan kode laporan
if (isset($_REQUEST['submit'])) {
    ...
    if (mysqli_num_rows($sql) > 0) {
        ...
        <div class="col-sm-1">
            <a href="?hlm=laporan" id="tombol" class="btn btn-info pull-left">
        ...
        echo '<tr><td><span class="pull-right"><h4><b>' . $nama . ' Orang</b></h4></span></td>
              <td><span class="pull-right"><h4><b>RP. ' . number_format($total) . '</b></h4></span></td></tr>';
        echo '
                </table>
            </div>
        </div>';
...
<?php
    ...
    echo '
        ...
        <div class="col-sm-1">
            <button id="tombol" onclick="window.print()" class="btn btn-warning pull-right">
                <span class="glyphicon glyphicon-print" aria-hidden="true"></span> Cetak
            </button>
        </div>
    </div>';
